  ...
  return (
    <div className="px-10 py-5">
      <div className="p-[10px]">
        <h1 className="text-4xl font-bold">Registration Details:</h1>
        <p className="text-xl px-[3em] pt-4">
          Participants are requested to pay a Registration Fee of Rs.250
        </p>
      </div>
      <div className="p-[10px]">
        <h1 className="text-4xl font-bold">Mode of Payment:</h1>
        <p className="text-xl px-[3em] pt-4">
      ...
      <div className="p-[10px]">
        <h1 className="text-4xl font-bold">Registration Link:</h1>
        <a className="link px-[3em]" href="https://forms.gle/bRCR4zbd3gUXkDXb7">
